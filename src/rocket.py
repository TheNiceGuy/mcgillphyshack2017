...
class Rocket(CelestialObject):
    ...
    def __init__(self, mass, radius, Parent_index,Parent, theta0, theta,path2='pictures/rocket.png', x=0, y=0, vx=0, vy=0, grounded=True,  qte_gas=200*1000, ejection_speed=0.0004, mass_flow=0.00000000000005, propulsion=False):
