...
jupiter = Planet(740520000000 ,0    ,0              ,13720          ,1.8986*10**27             ,200*69911000 , 12)
uranus  = Planet(2734998229000,0    ,0              ,7128           ,8.681 *10**25             ,200*2559000  , 18)
neptune = Planet(4452940833000,0    ,0              ,5479           ,102.43*10**24             ,200*2462200  , 76)
