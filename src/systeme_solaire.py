...
objectList.update({0:Planet(0            ,0    ,0              ,0              ,1.981*10**30              ,50*696342000 , 10**-7,path1='pictures/solei.jpg')})
...
objectList.update({3:Planet(147098079000 ,0    ,0              ,30287          ,5.9736*10**24             ,200*6371008  , 40*10**-7,path1='pictures/planete3.png')})
objectList.update({4:Planet(206644545000 ,0    ,0              ,26499          ,641.85*10**21             ,200*3389500  , 15*10**-7,path1='pictures/planetes4.png')})
