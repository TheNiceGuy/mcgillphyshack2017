...
objectList.update({0:Planet(0 ,0    ,0              ,0          ,5.9736*10**24             ,900*6371008  , 40*10**-7,path1='pictures/planete1.png')})
objectList.update({1:Planet(362600 , 0    ,0   ,1022          ,7.3*10**22             ,900*1737000 , 40*10**-7, path1='pictures/planete2.png')})
